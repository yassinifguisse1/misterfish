          ...
          <div className="container mx-auto max-w-[1200px] px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {[
                ...
                <div key={index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-t-4 border-[#4A90E2]">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#4A90E2] to-[#87CEEB] rounded-full flex items-center justify-center text-white mb-4">
                    {item.icon}
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-10">
                <h2 className="font-display font-black uppercase text-3xl lg:text-4xl mb-8 bg-gradient-to-r from-[#2E3F72] to-[#4A90E2] bg-clip-text text-transparent">
                ...
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#4A90E2] to-[#3498DB] text-white font-display font-bold uppercase px-8 py-4 rounded-full text-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                  >
                    Envoyer le Message
                  </button>
                </form>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-br from-[#2E3F72] to-[#3498DB] rounded-3xl shadow-xl p-8 text-white">
